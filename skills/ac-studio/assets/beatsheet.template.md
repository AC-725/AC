...
read is ~3.3 syl/sec on the approved Day 41 cut (body beats 2.5–3.6, hook beat up to 4.6); above 4.2 a body beat fails. **One clause per beat, max two. Full stop = pause.** The screen and the
...
|---|---|---|---|---|---|---|
| A · hook | 2.6s | 8–11 syl | | A | 3.6s | 10–13 |
